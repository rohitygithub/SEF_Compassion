...
public class SEF_OrganizationSponsorshipRN extends BaseClass {
	...
	By byOrganizationTypeDropdown     = By.xpath("(//div[2]/div[2]/div[1]/div[2]/div[1]/div[@class='ui dropdown selection'])[1]");
	By byOrganizationName             = By.xpath("(//div[2]/div[1]/div[3]/div[1]/input[@id='org_name new'])[1]");
	By byEnterEmail                   = By.xpath("(//div[6]/div[1]/div[1]/input[@id='orgemail'])[1]");
	By byTitleDropdown                = By.xpath("//div[3]/div[1]/div[@class='ui dropdown selection title']");
	By byFirstName                    = By.xpath("//div[3]/div[2]/div[1]/input[@id='name0']");
	By byLastName                     = By.xpath("//div[3]/div[3]/div[1]/input[@id='surname0']");
	By byclickonemail                 = By.xpath("//div[8]/div[1]/div[1]/input[@id='emailid0']");
	...
	@Parameters({"byApplicationCode", "byOrganizationName", "byEnterEmail", "byFirstName", "byLastName", "byclickonemail", "byAccountNameTextbox",
		"byAccountNumberTextbox", "bySortcodeTextbox"})
	@Test (groups = {"All", "SEF_OrganizationSponsorshipRN"})
	public void Organizatio_Sponsorship(@Optional ("1150") String AppCode,
			                            @Optional ("Digital Age Expo") String OrgName,
			                            @Optional ("jodol14188@chimpad.com") String Email,
			                            @Optional ("Sean") String FirstName,
			                            @Optional ("Brown") String LastName,
			                            @Optional ("jodol14188@chimpad.com") String Email2,
			                            @Optional ("Digital Age Expo") String AccName,
			                            @Optional ("34661743") String AccNumber,
			                            @Optional ("602003") String SortCode) {
		
		System.out.println("//***** Organization Sponsorship Started *****//" + '\n');
		...
		String value1 = list1.get(4).getText();
		System.out.println(value1);
		Utilities.hardWait(1);
		list1.get(4).click();
		Utilities.hardWait(2);
		
		driver.findElement(byOrganizationTypeDropdown).click();
		Utilities.hardWait(2);
		
		List<WebElement> list2 = driver.findElements(By.xpath("//div[@class='menu transition visible']//div"));
		String value2 = list2.get(2).getText();
		System.out.println(value2);
		Utilities.hardWait(1);
		list2.get(2).click();
		Utilities.hardWait(2);
		
		driver.findElement(byOrganizationName).sendKeys(OrgName);
		System.out.println("Organization Name :" + OrgName);
		Utilities.hardWait(3);
		
		driver.findElement(byEnterEmail).sendKeys(Email);
		System.out.println("Organization Email :" + Email + '\n');
		Utilities.hardWait(3);
		...
		driver.findElement(byclickonemail).sendKeys(Email2);
		System.out.println("Person Email :" + Email2);
		Utilities.hardWait(5);
		...
		for (int i =0; i<total_dates;i++)
			{
				...
				System.out.println('\n' +"//***** Organization Sponsorship Completed *****//" + '\n');
