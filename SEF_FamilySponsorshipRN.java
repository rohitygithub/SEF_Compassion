...
public class SEF_FamilySponsorshipRN extends BaseClass {
	...
	By byTitleDropdown3               = By.xpath("//div[5]/div[1]/div[@class='ui dropdown selection title']");
	...
	By bySupporterGroupPname          = By.xpath("//div[1]/div[2]/div[@class='ui dropdown selection']");
	...
	@Parameters({"byApplicationCode", "byFirstName", "byLastName", "byclickonEmail", "byFirstName2", "byLastName2", "byClickOnEmail2",
		"byFirstName3", "byLastName3", "byClickOnEmail3", "bySupporterGroupName", "byAccountNameTextbox", "byAccountNumberTextbox", "bySortcodeTextbox"})
	@Test (groups = {"All", "SEF_FamilySponsorshipRN"})
	public void Family_Sponsorship(@Optional ("1150") String AppCode,
		...
		System.out.println("Person 2 Last Name :" + FirstName2);
		...
		driver.findElement(bySupporterGroupName).sendKeys(SuupGName);
		
		Utilities.hardWait(2);
		
		driver.findElement(bySupporterGroupPname).click();
		Utilities.hardWait(1);
		
				
		List<WebElement> list5 = driver.findElements(By.xpath("//div[@class='menu transition visible']//div"));
		String value5 = list5.get(0).getText();
		...
		for (int i =0; i<total_dates;i++)
			{
			 ...
			 boolean E_mesg1 = driver.findElement(By.xpath("//div[1]/table[1]/tr[22]")).isDisplayed();
			 Utilities.hardWait(8);
			 boolean E_mesg2 = driver.findElement(By.xpath("//div[1]/table[1]/tr[23]")).isDisplayed();
			 Utilities.hardWait(8);
//			 boolean T_error = driver.findElement(By.xpath("//div[1]/table[1]/tr[26]/td[2]")).isDisplayed();
			 
			 Utilities.hardWait(8);
			 if(E_mesg1 && E_mesg2) {
			 
			 String error_mesg1 = driver.findElement(By.xpath("//div[1]/table[1]/tr[22]")).getText();
			 Utilities.hardWait(8);
			 String error_mesg2 = driver.findElement(By.xpath("//div[1]/table[1]/tr[23]")).getText();
			 Utilities.hardWait(8);
//			 String total_error = driver.findElement(By.xpath("//div[1]/table[1]/tr[26]/td[2]")).getText();
			 
			 System.out.println("Find Error's : "+'\n' + "-->" + error_mesg1 + '\n' + "-->" + error_mesg2 );
